...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.BookViewHolder> {
    ...
    private void bindBook(BookViewHolder holder, Book book, int position) {
        ...
        if (position % 2 == 0){
            holder.containerLayout.setBackgroundColor(context.getResources().getColor(R.color.book_background_2));
        } else {
            holder.containerLayout.setBackgroundColor(context.getResources().getColor(R.color.book_background_1));
        }
    }
